...
async def update_popular():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1673051707.bhcesh.me/list?token=ec18059a12110f229a7ca08670d1afd4&sort=-views&type=films&limit=50&year=2023', timeout=None) as response:
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1673051707.bhcesh.me/list?token=ec18059a12110f229a7ca08670d1afd4&sort=-views&type=serials&join_seasons=false&limit=50&year=2023', timeout=None) as response:
            response = await response.json()
    popular_series = []
    results = response['results']
    for result in results:
...
async def update_popular_mult():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1673051707.bhcesh.me/list?token=ec18059a12110f229a7ca08670d1afd4&sort=-views&type=cartoon&limit=50&year=2023', timeout=None) as response:
            response = await response.json()
    popular_cartoon = []
    results = response['results']
    for result in results:
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1673051707.bhcesh.me/list?token=ec18059a12110f229a7ca08670d1afd4&sort=-views&type=cartoon-serials&join_seasons=false&limit=50&year=2023', timeout=None) as response:
            response = await response.json()
...
async def update_popular_anime():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1673051707.bhcesh.me/list?token=ec18059a12110f229a7ca08670d1afd4&sort=-views&type=anime&limit=50&year=2023', timeout=None) as response:
            response = await response.json()
    popular_anime = []
    results = response['results']
    for result in results:
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1673051707.bhcesh.me/list?token=ec18059a12110f229a7ca08670d1afd4&sort=-views&type=anime-serials&join_seasons=false&limit=50&year=2023', timeout=None) as response:
            response = await response.json()
...
async def update_popular_show():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1673051707.bhcesh.me/list?token=ec18059a12110f229a7ca08670d1afd4&sort=-views&type=show&limit=50&year=2023', timeout=None) as response:
            response = await response.json()
    popular_show = []
    results = response['results']
    for result in results:
...
async def update_domain():
    global last_domain
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1665331096.bhcesh.me/embed-domain?token=ec18059a12110f229a7ca08670d1afd4') as response:
            response = await response.json()
...
async def update_news_films():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1664409738.bhcesh.me/video/news?limit=50&type=films&token=ec18059a12110f229a7ca08670d1afd4&year=2023', timeout=None) as response:
            response = await response.json()
    results = response['results']
    print(len(results))
    ...
    for result in results:
        film_id = result
        async with aiohttp.ClientSession() as session:
            async with session.get(f'https://api1663355922.bhcesh.me/franchise/details?token=ec18059a12110f229a7ca08670d1afd4&id={film_id}', timeout=None) as response:
...
async def update_news_serials():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1664409738.bhcesh.me/video/news?limit=50&join_seasons=false&type=serials&token=ec18059a12110f229a7ca08670d1afd4&year=2023', timeout=None) as response:
            response = await response.json()
    results = response['results']
    print(len(results))
    results = [result1['id'] for result1 in results]
    ...
    for result in results:
        film_id = result
        async with aiohttp.ClientSession() as session:
            async with session.get(f'https://api1663355922.bhcesh.me/franchise/details?token=ec18059a12110f229a7ca08670d1afd4&id={film_id}&join_seasons=false', timeout=None) as response:
                film_data = await response.json()
        name = film_data['name']
        type = category_list[film_data['type']]
        year = film_data["year"]
...
async def update_news_show():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1664409738.bhcesh.me/video/news?limit=300&type=show&token=ec18059a12110f229a7ca08670d1afd4&year=2023', timeout=None) as response:
            response = await response.json()
    results = response['results']
    print(len(results))
    results = [result1['id'] for result1 in results]
...
async def update_collections():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(f'https://api1662739038.bhcesh.me/collection?page=1&token=ec18059a12110f229a7ca08670d1afd4') as response:
            response = await response.json()
    ...
    for page in range(1, pages+1):
        async with aiohttp.ClientSession() as session:
            async with session.get(f'https://api1662739038.bhcesh.me/collection?page={page}&token=ec18059a12110f229a7ca08670d1afd4') as response:
                response = await response.json()
...
async def update_collections_films():
    ...
    for collection_items in collections['data'][41:]:
        ...
        # print('connect')
        async with aiohttp.ClientSession() as session:
            async with session.get(f'https://api1662830368.bhcesh.me/list?collection_id={collection_id}&token=ec18059a12110f229a7ca08670d1afd4') as response:
                response = await response.json()
        ...
        for page in range(1,pages+1):
            ...
            async with aiohttp.ClientSession() as session:
                async with session.get(f'https://api1662830368.bhcesh.me/list?page={page}&collection_id={collection_id}&limit=500&token=ec18059a12110f229a7ca08670d1afd4') as response:
                    response = await response.json()
            try:
...
async def next(call: types.CallbackQuery):
    ...
    if film_id not in favorites_ids:
        ...
        if len(film_data) == 0:
            params = {"id": film_id}
            film_data = requests.get("https://api1663355922.bhcesh.me/franchise/details?token=ec18059a12110f229a7ca08670d1afd4", params=params).json()
            try:
                genre = film_data['genre'].values()
                genre = ', '.join(genre)
            except KeyError:
...
async def send_message(user_id, message):
    try:
        await bot.send_message(user_id, message, parse_mode=types.ParseMode.MARKDOWN)
    except Exception as e:
        print(f"Error sending message to user {user_id}: {e}")

@dp.message_handler(commands=['all'])
async def handle_send_all(message: types.Message):
    if message.from_user.id != admin_id:
    ...
    for user in datausers:
        try:
            await send_message(user, message.text[message.text.find(" "):])
        except:
...
async def send(call: types.CallbackQuery):
    ...
    async def handle_text(message: types.Message, state: FSMContext):
     ...
     response = requests.get("https://api1650820663.bhcesh.me/franchise/details?token=ec18059a12110f229a7ca08670d1afd4",params=params).json()
     name = response['name']
     film_id = response['id']
     ...
     play.add(types.InlineKeyboardButton(text="😍 Смотреть онлайн", url=f'https://api.getcodes.ws/embed/movie/{film_id}?host=tg.movie'))
...
async def send(call: types.CallbackQuery):
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            response = requests.get("https://api1650820663.bhcesh.me/list?token=ec18059a12110f229a7ca08670d1afd4", params=params).json()['results']
            try:
